...
private:
	...
	Port &out_c1 ; // for sending out the messages to peer 1 // this needs to  be generated through a script
	Port &out_c2 ; // for sending out the messages to peer 2 // this needs to  be generated through a script
	Port &out_c3 ; // for sending out the messages to peer 3 // this needs to  be generated through a script
	Port &out_c4 ; // for sending out the messages to peer 4 // this needs to  be generated through a script
	Port &out_c5 ; // for sending out the messages to peer 5 // this needs to  be generated through a script
//..Port &out_k
